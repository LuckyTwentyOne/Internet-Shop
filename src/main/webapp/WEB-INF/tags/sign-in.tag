...
<form action="/iShop/sign-in" method="post">
	<c:if test="${fn:startsWith(CURRENT_REQUEST_URL,'/iShop/search') or fn:startsWith(CURRENT_REQUEST_URL, '/iShop/products') or 
						CURRENT_REQUEST_URL == '/iShop/shopping-cart' }">
